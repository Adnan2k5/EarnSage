# Earn Sage: AI-Powered Parametric Insurance for Gig Workers

## The Vision
Earn Sage provides an automated, AI-enabled parametric insurance platform designed exclusively for India's platform-based delivery partners. Our mission is to safeguard gig workers against income loss caused by external disruptions such as extreme weather or environmental conditions.
...
* **Persona:** Food and Q-Commerce Delivery Partners (e.g., Zomato, Swiggy, Zepto).
